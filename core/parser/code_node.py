...
class CodeNode:
    ...
    def process_line(self, line_data, indentation_level, line_number):
        if self.valid_node_settings(line_data, indentation_level, line_number):
            self.update_tmp_qbl_memory(line_data, indentation_level)

    def valid_node_settings(self, line_data, level_indentation_diff, line_number):
        return True

    def update_tmp_qbl_memory(self, line_data, level_indentation_diff):
        pass
